...
class Client:
    ...
    def _format_params(params):
        return {k: json.dumps(v) if isinstance(v, bool)
    ...
    def technical_indicator(self, symbol, resolution, _from, to,
                            indicator, indicator_fields=None):
