...
class ReturnRate():
    ...
    def three_plus_one_return(self, df, stock: str, date_ori: str):
        ...
        try:
            ...
            return_rate1 = np.log(d4_price/d0_price)
            return return_rate1
        except:
    ...
    def validate_three_plus_one(self, stock: str):
        """
        步骤3： 蠕动，计算回报率。
        :param stock: str 是validate_three_plus_one_stocks输入的具体每个股票的代码
        :return: 利润率的数据集
        """
...
if __name__ == '__main__':
    ...
    p = [11, 9, 11]
    symboldf = pg.get_symbol_df(s_date, e_date)
